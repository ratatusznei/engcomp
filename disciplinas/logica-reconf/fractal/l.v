...
//altecc_encoder CBX_AUTO_BLACKBOX="ALL" device_family="MAX 10" lpm_pipeline=0 width_codeword=72 width_dataword=64 data q
...
endmodule //l_altecc_encoder_6qa
//VALID FILE
...
module l (
	...
	l_altecc_encoder_6qa	l_altecc_encoder_6qa_component (
				.data (data),
				.q (sub_wire0));
