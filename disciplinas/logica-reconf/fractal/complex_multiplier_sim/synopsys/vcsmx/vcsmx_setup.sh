...
TOP_LEVEL_NAME="complex_multiplier"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/run/media/op/7c101ca4-10f4-41ca-a3a3-7f50176bc026/game/progs/Quartus-lite-18.1.0.625-linux/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/complex_multiplier.vhd"   
fi
